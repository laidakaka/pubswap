...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0x10ED43C718714eb63d5aA57B78B54704E256024E')).toBe('0x10ED43C718714eb63d5aA57B78B54704E256024E')
      expect(isAddress('0x10ED43C718714eb63d5aA57B78B54704E256024E')).toBe('0x10ED43C718714eb63d5aA57B78B54704E256024E')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('10ED43C718714eb63d5aA57B78B54704E256024E')).toBe('0x10ED43C718714eb63d5aA57B78B54704E256024E')
    })
    it('fails if too long', () => {
      expect(isAddress('10ED43C718714eb63d5aA57B78B54704E256024E')).toBe(false)
    })
  })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0x10ED43C718714eb63d5aA57B78B54704E256024E')).toBe('0x10ED...024E')
    })

    it('truncates middle characters even without prefix', () => {
      expect(shortenAddress('10ED43C718714eb63d5aA57B78B54704E256024E')).toBe('0x10ED...024E')
    })
